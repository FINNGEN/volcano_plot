...
/////////////////////////////////////////////////////
        ...
        function volcano(data) {
          ...
          //create x-scale
          var xScale = d3.scaleLinear().domain([betaMin - betaMax, betaMax + (betaMin * (-1))]) //make x-scale symmetrical
            .range([0, width]);
          ...
          const sqrtScale = d3.scaleSqrt().domain([0, max]).range([2, 2.02]); //only allow a slight change in values since variation is huge
          var fileInput = document.getElementById('data-file');
          var filename = fileInput.files[0].name;
